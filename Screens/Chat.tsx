...
import { View, Text, StyleSheet, TouchableOpacity, useColorScheme, Image, StatusBar, TextInput, ScrollView, useWindowDimensions, Alert, KeyboardAvoidingViewComponent, KeyboardAvoidingView, Keyboard } from 'react-native';
                    ...
                    <View style={{ width: '100%', height: '100%', marginVertical: 5, padding: 15, marginTop: 20 }}>
                        {
                            messages.length ? (
                                messages.map((el, inx) => {
                                    ...
                                    return (
                                        userData.id === 1 ? (
                                            <View style={[styles.userDegin, {alignSelf:'flex-end'}]} key={inx}>
                                                <Text style={[styles.userchatMassage, { color: 'white' }]}>{el.text}</Text>
                                            </View>
                                        ) : (
                                            <View style={[styles.userDegin,{alignSelf:'flex-start'}]} key={inx}>
                                                <Text style={[styles.userchatMassage, { color: 'white' }]}>{el.text}</Text>
                                            </View>
                                        )
